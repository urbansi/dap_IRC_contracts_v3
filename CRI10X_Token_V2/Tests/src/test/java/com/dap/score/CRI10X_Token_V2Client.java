...
class CRI10X_Token_V2Client extends TestClient<CRI10X_Token_V2Client> implements IRC2, ICRI10X_Token_V2 {
  public CRI10X_Token_V2Client (Account caller, Score target) {
    super(caller, target);
  }
