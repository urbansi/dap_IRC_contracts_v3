...
public class CRI10X_Token_V2Test extends TestBase {
  ...
  protected CRI10X_Token_V2Client client;
  
  @BeforeEach
  public void setup() throws Exception {
    this.client = new CRI10X_Token_V2Client(owner, sm.deploy(owner, CRI10X_Token_V2.class, 18));
  }
  ...
  void transferFromOnlyOwner () {
    ...
    AssertUtils.assertThrowsMessage(AssertionError.class, 
      () -> this.client.transferFrom(owner.getAddress(), alice.getAddress(), amount, "".getBytes()), 
      "Reverted(0): CRI10X_Token_V2: Only owner function");
  }
  ...
  void fallback () {
    AssertUtils.assertThrowsMessage(AssertionError.class, 
      ...
      "Reverted(0): CRI10X_Token_V2 does not accept ICX.");
  }
}