...
public class LEND5_Token_V2 implements IRC2, ILEND5_Token_V2 {

  // ================================================
  // Consts
  // ================================================
  public final String TAG = "LEND5_Token_V2";
  ...
  // Methods
  // ================================================
  public LEND5_Token_V2 (int _decimals) {
    if (_decimals < 0) {
  ...
  public void transferFrom (Address _from, Address _to, BigInteger _value, @Optional byte[] _data) {
    if (!Context.getCaller().equals(Context.getOwner())) {
      revert("LEND5_Token_V2: Only owner function");
    }
  ...
  public void burn(Address _account, BigInteger _amount) {
    ...
    if (this._balances.getOrDefault(_account, ZERO).compareTo(_amount) < 0) {
      revert("LEND5_Token_V2: Account has not sufficient funds.");
    }
  ...
  public void fallback() {
    revert("LEND5_Token_V2 does not accept ICX.");
  }
}
