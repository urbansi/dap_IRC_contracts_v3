...
class LEND5_Token_V2Client extends TestClient<LEND5_Token_V2Client> implements IRC2, ILEND5_Token_V2 {
  public LEND5_Token_V2Client (Account caller, Score target) {
    super(caller, target);
  }
