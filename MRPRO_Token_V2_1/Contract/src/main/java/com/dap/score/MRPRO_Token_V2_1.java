...
public class MRPRO_Token_V2_1 implements IRC2, IMRPRO_Token_V2_1 {

  // ================================================
  // Consts
  // ================================================
  public final String TAG = "MRPRO_Token_V2_1";
  ...
  // Methods
  // ================================================
  public MRPRO_Token_V2_1 (int _decimals) {
    if (_decimals < 0) {
  ...
  public void transferFrom (Address _from, Address _to, BigInteger _value, @Optional byte[] _data) {
    if (!Context.getCaller().equals(Context.getOwner())) {
      revert("MRPRO_Token_V2_1: Only owner function");
    }
  ...
  public void burn(Address _account, BigInteger _amount) {
    ...
    if (this._balances.getOrDefault(_account, ZERO).compareTo(_amount) < 0) {
      revert("MRPRO_Token_V2_1: Account has not sufficient funds.");
    }
  ...
  public void fallback() {
    revert("MRPRO_Token_V2_1 does not accept ICX.");
  }
}
