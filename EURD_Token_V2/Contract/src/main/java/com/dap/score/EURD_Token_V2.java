...
public class EURD_Token_V2 implements IRC2, IEURD_Token_V2 {

  // ================================================
  // Consts
  // ================================================
  public final String TAG = "EURD_Token_V2";
  ...
  // Methods
  // ================================================
  public EURD_Token_V2 (int _decimals) {
    if (_decimals < 0) {
  ...
  public void transferFrom (Address _from, Address _to, BigInteger _value, @Optional byte[] _data) {
    if (!Context.getCaller().equals(Context.getOwner())) {
      revert("EURD_Token_V2: Only owner function");
    }
  ...
  public void burn(Address _account, BigInteger _amount) {
    ...
    if (this._balances.getOrDefault(_account, ZERO).compareTo(_amount) < 0) {
      revert("EURD_Token_V2: Account has not sufficient funds.");
    }
  ...
  public void fallback() {
    revert("EURD_Token_V2 does not accept ICX.");
  }
}
